...
| Find a category's children                         | reads the names of the categories filed under one category, ordered by name                                | [List a grouping's categories](../../usecases/list-categories.md)                                                                                                                                      |
