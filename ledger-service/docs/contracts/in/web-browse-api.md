...
| `expenses`    | `changeExpenseCategory` | the entry as it now stands, under a different category                                   | [Change an entry's category](../../usecases/change-an-expense-category.md)       | nothing yet                                                                               |
