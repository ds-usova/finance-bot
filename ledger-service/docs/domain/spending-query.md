...
- A query is only ever recorded, never changed and never removed.
...
- [Act on a user's message](../usecases/handle-incoming-message.md) — reads back what one message asked, and
  totals each period.
