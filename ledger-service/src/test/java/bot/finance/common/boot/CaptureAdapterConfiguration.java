 ...
 * which database they point at. The registry serves the cdc-owned meters; the outbox meter port is a mock,
 * since what it renders is {@code MicrometerOutboxMetersTest}'s to prove.
 *
...
public class CaptureAdapterConfiguration {
    ...
    OutboxMeters outboxMeters() {
        return Mockito.mock(OutboxMeters.class);
    }
