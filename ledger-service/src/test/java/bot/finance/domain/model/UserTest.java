...
class UserTest {
    ...
    class Equality {
        ...
        @Test
        @DisplayName("when a stored user and an unstored user share the same external id - then they are equal and their hash codes match")
        ...
        @Test
        @DisplayName("when two stored users share the same database id but differ in external id - then they are not equal")
