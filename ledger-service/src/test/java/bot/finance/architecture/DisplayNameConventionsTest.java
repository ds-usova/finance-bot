...
class DisplayNameConventionsTest {
    ...
    /**
     * Off until the names it finds are dealt with: 276 of this module's test methods overrun, 100 of them past
     * 160 characters. An overrun is a test proving several things at once, so most of those want splitting rather
     * than a shorter name - work nobody has scheduled. Remove the annotation once they are.
     */
    @ArchIgnore(reason = "276 existing overruns; enabling this is a cleanup of its own")
    @ArchTest
