...
| task 40   | R2 | `web-app`, `ledger-service`              | show module-owned wording for a refused call, instead of the ledger's own English message                   | [findings](implemented/40-set-a-default-currency/review/findings.md)                        |
