...
| task 33   | R1 | `ai-connector-service`                   | split `AiMessageEmbeddingAdapterTest`'s short-vector-list and server-error scenarios into two tests          | [findings](implemented/33-the-model-reads-the-connectors-memory/review/findings.md)          |
