...
| C8 | task 44   | `web-app`              | move the malformed-2xx-body diagnostic literals off their hardcoded English wording                      | [findings](implemented/44-the-browser-owns-its-refusal-wording/review/findings.md)          |
