...
- **The incoming-message flow** — [`TelegramUpdateListener`](../ledger-service/src/main/java/bot/finance/adapter/telegram/TelegramUpdateListener.java)
  ...
  the user nothing. Designed in [9-design-handle-incoming-message-extracts-intents](../9-handle-incoming-message-extracts-intents/design.md).
...
- Basis: assumed — every stored row today comes from the private-chat flow that
  [9-design-handle-incoming-message-extracts-intents](../9-handle-incoming-message-extracts-intents/design.md)
