...
Follow-up to [Create an expense](implemented/5-plan-create-expense.md). Four conventions
...
`User`'s identity becomes its id, reversing **Q6** of [plan 3](implemented/3-plan-initialize-a-new-user.md). Nothing
