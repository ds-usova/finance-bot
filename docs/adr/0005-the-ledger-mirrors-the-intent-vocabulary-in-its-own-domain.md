...
- **Status:** Accepted
- **Date:** 2026-07-28
- **Source:** [Call the AI Connector from the Ledger Service](../implemented/4-ledger-ai-connector-integration/plan.md)
...
- 2026-07-31: since [plan 9](../implemented/9-handle-incoming-message-extracts-intents/plan.md) no intent
