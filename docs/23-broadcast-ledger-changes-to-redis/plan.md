...
- [ ] GS03 · `CaptureDisabledSystemTest` · covers: `GET /actuator/health`
- [ ] GS04 · `RecoverSlotSystemTest` · covers: `POST /actuator/cdc`
- [ ] GS05 · `ChangeStreamMetersSystemTest` · covers: `GET /actuator/prometheus`
- [ ] GS06 · `McpAuthenticationSystemTest` · covers: `POST /mcp`
- [ ] GS07 · `WebSessionSystemTest` · covers: `GET /api/v1/session`
