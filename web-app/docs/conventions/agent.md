...
The list goes in the task's `review/findings.md`, under this module's own heading: the screens and the states to
check, carried from the design rather than invented.
