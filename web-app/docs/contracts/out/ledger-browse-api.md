...
- **Every figure**: shown as the ledger rendered it. The currency, the separator and the amount join in that
  order, and none of the three is parsed or reformatted here.
