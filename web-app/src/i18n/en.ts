...
export const en = {
  ...
  listing: {
    ...
    acceptanceMalformed: 'Something went wrong. Please try again.',
    categoryChangeMalformed: 'Something went wrong. Please try again.',
  },
  filters: {
    title: 'Filters',
    category: 'Category',
  ...
  settings: {
    ...
    preferencesMalformed: 'Something went wrong. Please try again.',
  },
