 ...
 * autoconfiguration only — no gRPC server, no other adapter. {@code spring.ai.openai.base-url} is redirected to
...
@ImportAutoConfiguration({OpenAiChatAutoConfiguration.class, ChatClientAutoConfiguration.class})
