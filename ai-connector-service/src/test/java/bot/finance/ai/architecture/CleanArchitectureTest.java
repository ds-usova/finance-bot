...
class CleanArchitectureTest {
    ...
    static final ArchRule layersRespectCleanArchitectureDependencies = layeredArchitecture()
            ...
            .layer("Domain")
            .definedBy("bot.finance.ai.domain..")
            .layer("Application")
            .definedBy("bot.finance.ai.application..")
            .layer("Adapter")
            .definedBy("bot.finance.ai.adapter..")
            .whereLayer("Domain")
    ...
    static final ArchRule domainAndApplicationStayFrameworkAgnostic = noClasses()
            .that()
            .resideInAnyPackage("bot.finance.ai.domain..", "bot.finance.ai.application..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
                    "org.springframework..",
    ...
    static final ArchRule adaptersReachUseCasesThroughPorts = noClasses()
            .that()
            .resideInAnyPackage("bot.finance.ai.adapter..")
            .and()
            .resideOutsideOfPackage("bot.finance.ai.adapter.config..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage("bot.finance.ai.application.usecase..")
            .allowEmptyShould(true);
    ...
    static final ArchRule inboundPortCommandsAreNamedAfterTheirUseCase = classes()
            .that()
            .resideInAPackage("bot.finance.ai.application.port")
            .and()
            .areInterfaces()
