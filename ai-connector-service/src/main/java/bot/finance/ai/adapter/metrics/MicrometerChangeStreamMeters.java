...
public class MicrometerChangeStreamMeters implements ChangeStreamMeters {
    ...
    public MicrometerChangeStreamMeters(MeterRegistry meterRegistry, PendingEntries pendingEntries) {
        ...
        Gauge.builder("ai_cdc_entries_pending", pendingEntries, PendingEntries::count)
